    ...
    <div class="background_image ">
        <div class="w3-display-middle w3-large ">
            <form class="w3-round w3-padding" @submit.prevent="submitHendler()">
                ...
                <input class="icon-user w3-input w3-padding w3-border w3-round-xlarge" type="email" v-model="_LOGIN"
                ...
                <input class="w3-input w3-padding w3-border w3-round-xlarge" type="password" v-model="_PASSWORD"
                    required>
                ...
                <button class="w3-btn w3-light-grey w3-border w3-margin-40 w3-border w3-round-xlarge"
                    @click="submitHendler()" :disabled=v$.$invalid>Войти</button>
            </form>
        </div>
    </div>
</template>
